						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/admin/store/create">
								    ...
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Name"  id="setting-input-1" name="name" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="email" class="form-control"  placeholder="Enter Email"  id="setting-input-2" name="email" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="password" class="form-control"  placeholder="Enter Password Confirmation"  id="setting-input-4" name="password_confirmation" required>
									</div>
