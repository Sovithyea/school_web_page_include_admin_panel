	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/user/store/create">
                                    @csrf
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter First Name"  id="setting-input-1" name="firstname" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Last Name"  id="setting-input-2" name="lastname" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Username"  id="setting-input-3" name="username" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="email" class="form-control"  placeholder="Enter Email"  id="setting-input-4" name="email" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="number" class="form-control"  placeholder="Enter Phone Number"  id="setting-input-6" name="phonenumber" required>
									</div>
