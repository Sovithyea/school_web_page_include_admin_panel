	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
                    <div class="col-auto">						    
                        <a class="btn app-btn-secondary" href="/admin/user/create">
										...
										<tbody>
											@foreach ($users as $user)
                                                <tr>
                                                    ...
                                                    <td class="cell"><span class="truncate">{{$user->gender}}</span></td>
                                                    <td class="cell"><span class="truncate">{{$user->email}}</span></td>
                                                    <td class="cell"><span class="truncate">{{$user->phonenumber}}</span></td>
                                                    <td class="cell">
