						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/user/{{$user->id}}/update">
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="password" class="form-control"  placeholder="Enter Password"  id="setting-input-3" value="{{$user->password}}" name="password" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="password" class="form-control"  placeholder="Enter Password Confirmation"  id="setting-input-4" name="password_confirmation" value="{{$user->password}}" required>
									</div>
