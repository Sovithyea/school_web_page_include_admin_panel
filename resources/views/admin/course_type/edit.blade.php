@extends('admin.layouts.master')
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">		
                ...
                <h1 class="app-page-title">Edit Course Type</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">Course Type: {{$course_type->title}}</h3>
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/course-type/{{$course_type->id}}/update">
                                    @method('PATCH')
                                    @csrf
								    <div class="mb-3">
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Course Type Title"  id="setting-input-1" value="{{$course_type->title}}" name="title" required>
									</div>
									<button type="submit" class="btn app-btn-primary" >Update Course Type</button>
							    </form>
						    </div><!--//app-card-body-->
