    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">		
                ...
                <h1 class="app-page-title">Edit Event</h1>
			    <hr class="mb-4">
	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/event/{{$event->id}}/update" enctype="multipart/form-data">
                                    @method('PATCH')
                                    @csrf
								    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Topic" value="{{$event->topic}}" id="setting-input-1" name="topic" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="file" class="form-control"  placeholder="Enter Event Image"  id="setting-input-2" name="image">

                                        <div class="img-thumnail" style="width: 150px">
                                            <img 
                                        
                                                src="{{asset('storage/'.$event->image)}}" class="w-100 mt-3"
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Location" value="{{$event->location}}"  id="setting-input-3" name="location" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Date"  id="setting-input-4" value="{{$event->date}}" name="date" required>
									</div>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control"  placeholder="Enter Time"  id="setting-input-6" value="{{$event->time}}" name="time" required>
									</div>

                                    
                                    <div class="mb-3">
                                        <label for="description" class="form-label">Description:</label>
                                        <textarea id="description" name="description" class="form-control @if($errors->has('description')) is-invalid @endif">{{old('description', $event->description)}}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea style="height: 10rem" name="map" class="form-control @if($errors->has('map')) is-invalid @endif">{{old('map', $event->map)}}</textarea>
									</div>



									<button type="submit" class="btn app-btn-primary my-3" >Update Event</button>
							    </form>
						    </div><!--//app-card-body-->
