	                ...
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
						    ...
						    <div class="app-card-body">
							    <form class="settings-form" method="post" action="/admin/course/{{$course->id}}/update" enctype="multipart/form-data">
                                    @method('PATCH')
                                    @csrf
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="text" value="{{old('title', $course->title)}}" class="form-control"  placeholder="Enter Course Title"  id="setting-input-1" name="title" required>
									</div>
									...
									<div class="mb-3">
										...
										<select name="course_type" class="@if($errors->has('course_type')) is-invalid @endif  form-control" id="course_type" >
											...
											@foreach ($course_types as $course_type)
											  <option @selected(old('course_type', $course->course_type_id) == $course_type->id)  value="{{$course_type->id}}">{{$course_type->title}}</option>
											@endforeach
										</select>
                                    ...
                                    <div class="mb-3">
									    ...
									    <input type="number" value="{{old('price', $course->price)}}" class="form-control"  placeholder="Enter Course Price"  id="setting-input-2" name="price" required>
									</div>
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" value="{{old('duration', $course->duration)}}" placeholder="Enter Course Duration"  id="setting-input-3" name="duration" required>
									</div>
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" value="{{old('skill_level', $course->skill_level)}}"  placeholder="Enter Course Skill Level"  id="setting-input-4" name="skill_level" required>
									</div>
                                    <div class="mb-3">
									    ...
									    <input type="text" class="form-control" value="{{old('start_class', $course->start_class)}}" placeholder="Enter Course Start Class"  id="setting-input-1" name="start_class" required>
									</div>
									...
									<div class="mb-3">
                                        ...
                                        @endif
                                        <div class="img-thumnail" style="width: 150px">
                                            <img 
                                        
                                                src="{{asset('storage/'.$course->image)}}" class="w-100 mt-3"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea id="test" name="description" class="form-control @if($errors->has('description')) is-invalid @endif">{{old('description', $course->description)}}</textarea>
									...
									<button type="submit" class="btn app-btn-primary my-3" >Update Course</button>
							    </form>
						    </div><!--//app-card-body-->
